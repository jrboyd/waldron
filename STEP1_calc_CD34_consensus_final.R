...
ssvSignalHeatmap(k27_clust[id %in% sample(unique(id), 300)])


valid_id = k27_clust_assignment[cluster_id != 3]$id
k27_consenus = k27_clust[id %in% valid_id] %>% GRanges %>% reduce

save(k27_consenus, k4_consenus, file = "CD34_consensus_v1.save")
